...
+ Table 2: Poisson + linear regressions for community follow-up compared with clinic follow-up
+ Table 3: Poisson + linear regressions with VS as predictor, and including CD4+
...
## Table 3: Cardiovascular risk among people virally suppressed versus those not virally suppressed at endline and controlling for CD4+ count, in South Africa(N = 983).
