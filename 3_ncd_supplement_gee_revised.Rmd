...
+ S3, Table 1: Table 3 for all sites (unadjusted and adjusted)
+ S3, Table 2: Table 3 for clinic arm (unadjusted and adjusted)
+ S3, Table 3: Table 3 for community arm (unadjusted and adjusted)
+ S3, Table 4: Interaction term coefficients 

## S4: Additional Figures

+ S4 Figure 1: CVD variables, comparing community follow-up with clinic follow-up
+ S4 Figure 2: CVD variables, comparing VS versus not - CLINIC FOLLOW-UP GROUP
+ S4 Figure 3: CVD variables, comparing VS versus not - COMMUNITY FOLLOW-UP GROUP
...
## Appendix S3, Table 1: Cardiovascular risk among people virally suppressed versus those not virally suppressed at endline, in South Africa (N = 983).
...
## Appendix S3, Table 2: Cardiovascular risk among people virally suppressed versus those not virally suppressed at endline, in the clinic-based follow-up arm (N = 341).
...
## Appendix S3, Table 3: Cardiovascular risk among people virally suppressed versus those not virally suppressed at endline, in the community-based follow-up arm (N = 642).
...
## Appendix S3, Table 4: Coefficients for interaction term for cardiovascular risk for persons virally suppressed versus not suppressed at endline in South Africa (N = 983).
...
## S4 Figure 2: Distribution, by VS status at endline [dashed lines are group medians] - CLINIC ONLY
...
## S4 Figure 4: Distribution of CVD variables by age
