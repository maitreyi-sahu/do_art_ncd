...
+ S2, Table 2: Descriptive statistics of cardiovascular risk in the DO ART study for South Africa, by viral suppression (N = 1010)
+ S2, Table 3: Descriptive statistics of cardiovascular risk in the DO ART study, by site and including Uganda (N = 1315) 
...
+ S5 Figure 2: Districbution of CVD risk by gender [SEE OTHER FILE]
...
## Appendix Table 2: Descriptive statistics of cardiovascular risk in the DO ART study for South Africa, by viral suppression (N = 1010)
...
## Appendix Table 3: Descriptive statistics of cardiovascular risk in the DO ART study, by site (N = 1315)
...
for (v in unique(reg_vars$var_name)) {
  ...
  adj.m <- geeglm(get(v) ~ site + age_cat + genderR + smokingR + educationR + exit_viral_load_suppressed, 
              family = poisson, data = vs_subset,
              id = hhid, corstr = "independence") 
  ...
  adj.m <- geeglm(get(v) ~ site + age_cat + genderR + educationR + exit_viral_load_suppressed, 
              family = poisson, data = vs_subset,
              id = hhid, corstr = "independence") 
...
for (v in unique(lin_reg_vars$var_name)) {
  ...
  adj.lm <- geeglm(get(v) ~  site + age_cat + genderR + smokingR + educationR + exit_viral_load_suppressed, 
              family = gaussian, data = vs_subset,
              id = hhid, corstr = "independence") 
...
for (v in unique(reg_vars$var_name)) {
  ...
  adj.m <- geeglm(get(v) ~ site + age_cat + genderR + smokingR + educationR + exit_viral_load_suppressed*armR, 
              family = poisson, data = vs_subset,
              id = hhid, corstr = "independence") 
  ...
  adj.m <- geeglm(get(v) ~ site + age_cat + genderR + educationR + exit_viral_load_suppressed*armR, 
              family = poisson, data = vs_subset,
              id = hhid, corstr = "independence") 
...
for (v in unique(lin_reg_vars$var_name)) {
  ...
  adj.lm <- geeglm(get(v) ~  site + age_cat + genderR + smokingR + educationR + exit_viral_load_suppressed*armR, 
              family = gaussian, data = vs_subset,
              id = hhid, corstr = "independence") 
...
for (v in unique(reg_vars$var_name)) {
  ...
  # Women
  m <- geeglm(get(v) ~ site + age_cat + smokingR + educationR + exit_viral_load_suppressed, 
  ...
  # Men 
  adj.m <- geeglm(get(v) ~ site + age_cat + smokingR + educationR + exit_viral_load_suppressed, 
  ...
  # Women
  m <- geeglm(get(v) ~ site + age_cat + educationR + exit_viral_load_suppressed, 
              family = poisson, data = ncd_merged_women,
              id = hhid, corstr = "independence") 
  m.rr <- exp(coef(m)[["exit_viral_load_suppressedTRUE"]]) # Relative Risk
  m.se <- summary(m)$coef["exit_viral_load_suppressedTRUE",2] # SE
  ...
  # Men
  adj.m <- geeglm(get(v) ~ site + age_cat + educationR + exit_viral_load_suppressed, 
              family = poisson, data = ncd_merged_men,
              id = hhid, corstr = "independence") 
...
for (v in unique(lin_reg_vars$var_name)) {
   ...
   # Midlands
  lm <- geeglm(get(v) ~ site + age_cat + smokingR + educationR + exit_viral_load_suppressed, 
  ...
  # Northern
  adj.lm <- geeglm(get(v) ~  site + age_cat + smokingR + educationR + exit_viral_load_suppressed, 
...
for (v in unique(reg_vars$var_name)) {
  ...
  adj.m <- geeglm(get(v) ~ site + age_cat + genderR + smokingR + exit_viral_load_suppressed + educationR + baseline_cd4, 
              family = poisson, data = vs_subset,
              id = hhid, corstr = "independence") 
  ...
  adj.m <- geeglm(get(v) ~ site + age_cat + genderR + exit_viral_load_suppressed + educationR + baseline_cd4, 
              family = poisson, data = vs_subset,
              id = hhid, corstr = "independence") 
...
for (v in unique(lin_reg_vars$var_name)) {
  ...
  adj.lm <- geeglm(get(v) ~  site + age_cat + genderR + smoking_status + exit_viral_load_suppressed + educationR + baseline_cd4, 
              family = gaussian, data = vs_subset,
              id = hhid, corstr = "independence") 
  adj.rd <- coef(adj.lm)[["exit_viral_load_suppressedTRUE"]] # Mean Difference
  adj.lm.se <- summary(adj.lm)$coef["exit_viral_load_suppressedTRUE",2] # SE
...
for (v in unique(reg_vars$var_name)) {
  ...
  # Midlands
  m <- geeglm(get(v) ~ age_cat + genderR + smokingR + educationR + exit_viral_load_suppressed, 
  ...
  # Northers  
  adj.m <- geeglm(get(v) ~ age_cat + genderR + smokingR + educationR + exit_viral_load_suppressed, 
  ...
  # Midlands  
  m <- geeglm(get(v) ~ age_cat + genderR + educationR + exit_viral_load_suppressed, 
              family = poisson, data = ncd_merged_midlands,
              id = hhid, corstr = "independence") 
  m.rr <- exp(coef(m)[["exit_viral_load_suppressedTRUE"]]) # Relative Risk
  m.se <- summary(m)$coef["exit_viral_load_suppressedTRUE",2] # SE
  ...
  # Northern
  adj.m <- geeglm(get(v) ~ age_cat + genderR + educationR + exit_viral_load_suppressed, 
              family = poisson, data = ncd_merged_northern,
              id = hhid, corstr = "independence") 
...
for (v in unique(lin_reg_vars$var_name)) {
   ...
   # Midlands
  lm <- geeglm(get(v) ~ age_cat + genderR + smokingR + educationR + exit_viral_load_suppressed, 
  ...
  # Northern
  adj.lm <- geeglm(get(v) ~  age_cat + genderR + smokingR + educationR + exit_viral_load_suppressed, 
...
p1 <- ggplot(df, aes(x = education, y = sbp_mean_exit, fill = exit_viral_load_suppressedR)) +
  geom_boxplot(varwidth = TRUE, alpha = 0.7)  +
  scale_fill_manual(values = vs_colors)+
  ylab(cvd_label) + xlab("Education") +
...
p2 <-  ggplot(df, aes(x = education, y = dbp_mean_exit, fill = exit_viral_load_suppressedR)) +
  geom_boxplot(varwidth = TRUE, alpha = 0.7)  +
  scale_fill_manual(values = vs_colors)+
  ylab(cvd_label) + xlab("Education") +
  geom_hline(yintercept = c(cvd_cutoff1, cvd_cutoff2), linetype = "dashed", size = .6) +
...
p3 <-  ggplot(df, aes(x = education, y = bmi, fill = exit_viral_load_suppressedR)) +
  geom_boxplot(varwidth = TRUE, alpha = 0.7)  +
  scale_fill_manual(values = vs_colors)+
  ylab(cvd_label) + xlab("Education") +
  geom_hline(yintercept = c(cvd_cutoff1, cvd_cutoff2), linetype = "dashed", size = .6) +
...
p4 <-  ggplot(df, aes(x = education, y = hemoglobin_a1c_result, fill = exit_viral_load_suppressedR)) +
  geom_boxplot(varwidth = TRUE, alpha = 0.7)  +
  scale_fill_manual(values = vs_colors)+
  ylab(cvd_label) + xlab("Education") +
  geom_hline(yintercept = c(cvd_cutoff1, cvd_cutoff2), linetype = "dashed", size = .6) +
...
p5 <-  ggplot(df, aes(x = education, y = lipid_result, fill = exit_viral_load_suppressedR)) +
  geom_boxplot(varwidth = TRUE, alpha = 0.7)  +
  scale_fill_manual(values = vs_colors)+
  ylab(cvd_label) + xlab("Education") +
  geom_hline(yintercept = c(cvd_cutoff1, cvd_cutoff2), linetype = "dashed", size = .6) +
